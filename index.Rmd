...
1. [Before we start](00-before-we-start.Rmd)
2. [Introduction to R](01-intro-to-R.Rmd)
3. [Starting with data](02-starting-with-data.Rmd)
4. [Aggregating and analyzing data with dplyr](03-dplyr.Rmd)
5. [Data visualization with ggplot2](04-visualization-ggplot2.Rmd)
6. [R and Databases](05-r-and-databases.Rmd)
...
using R much easier and more interactive. You need R installed before you
install RStudio. After installing both of the programs, you will need to install
the `tidyverse` package within RStudio. Follow the instructions below for your
...
* To check the version of R you are using, start RStudio and the first thing
  that appears on the terminal indicates the version of R you are running. Go on
...
**In any case you will also need to install the "tidyverse" package.**

* After starting RStudio, at the terminal type:
